...
ALTER TABLE public.t_restaurant
    ADD FK_MENU_FIELD INT8 AS (CASE deleted WHEN TRUE THEN NULL ELSE fk_menu END);
ALTER TABLE public.t_restaurant
    ADD FK_ADDRESS_FIELD INT8 AS (CASE deleted WHEN TRUE THEN NULL ELSE fk_address END);
