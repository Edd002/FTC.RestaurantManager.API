CREATE TABLE public.t_restaurant (
    ...
    breakfast_closing_hours time(6) NULL,
    breakfast_opening_hours time(6) NULL,
    dinner_closing_hours time(6) NULL,
    dinner_opening_hours time(6) NULL,
    lunch_closing_hours time(6) NULL,
    lunch_opening_hours time(6) NULL,
