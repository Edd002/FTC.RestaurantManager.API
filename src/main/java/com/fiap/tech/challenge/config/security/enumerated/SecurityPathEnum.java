package com.fiap.tech.challenge.config.security.enumerated;
...
public enum SecurityPathEnum {
    ...
    public static List<SecurityPathEnum> getIgnoreRequestFilterPaths() {
    ...
    public static List<SecurityPathEnum> getIgnoreResponseFilterPaths() {
        return Arrays.asList(
                API_V1_JWTS_GENERATE_POST,
