    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        httpSecurity
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers(PathEnum.API_V1_USER_TYPES_DELETE.getHttpMethod(), PathEnum.API_V1_USERS_FILTER_GET.getPath()).hasAuthority(DefaultUserTypeEnum.ADMIN.name())
                        .requestMatchers(PathEnum.API_V1_USER_TYPES_GET.getHttpMethod(), PathEnum.API_V1_USERS_POST.getPath()).hasAuthority(DefaultUserTypeEnum.ADMIN.name())
                        .requestMatchers(PathEnum.API_V1_USER_TYPES_FILTER_GET.getHttpMethod(), PathEnum.API_V1_USERS_FILTER_GET.getPath()).hasAuthority(DefaultUserTypeEnum.ADMIN.name())
                        .requestMatchers(PathEnum.API_V1_USER_TYPES_POST.getHttpMethod(), PathEnum.API_V1_USERS_POST.getPath()).hasAuthority(DefaultUserTypeEnum.ADMIN.name())
                        .requestMatchers(PathEnum.API_V1_USER_TYPES_PUT.getHttpMethod(), PathEnum.API_V1_USERS_FILTER_GET.getPath()).hasAuthority(DefaultUserTypeEnum.ADMIN.name())
